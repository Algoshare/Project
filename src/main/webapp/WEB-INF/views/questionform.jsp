	...
	<div class="wrap">
		...
		<div class="col-xs-7">
			<textarea class="form-control" rows="7" id="content"
				placeholder="문제에 대한 설명을 입력하세요"></textarea>
			<br>
		</div>
		<br>
		<br>
		...
		<br>
		<div class="col-xs-7">
			<textarea class="form-control" rows="4" id="input"
				placeholder="문제의 입력값에 대해서 입력하세요"></textarea>
			<br>
		</div>
		<br>
		<br>
		...
		<br>
		<div class="col-xs-7">
			<textarea class="form-control" rows="4" id="output"
				placeholder="문제의 출력값에 대해서 입력하세요"></textarea>
		</div>
		<br>
		<br>
		<br>
		...
		<div class="col-xs-3">
			<label for="exampleInputPassword1">마감 기한</label> <input type="date"
				class="form-control" id="due"><br>
		</div>
		<br> <br> <br> <br>
		<div class="col-sm-10">
			<button class="btn btn-primary"
				onclick="questionokonclick(<%=room_no%>);">확인</button>
...
<script src="resources/common/hyo/js/form.js?ver=2 charset='utf-8'"></script>
<script src="resources/common/hyo/js/jquery.min.js"></script>
</html>